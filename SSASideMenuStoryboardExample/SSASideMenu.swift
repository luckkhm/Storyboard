    ...
    private func animateMenuViewController(side: SSASideMenuSide) {
        ...
        if type == .Scale {
            if side == .Left {
                ...
                contentViewContainer.transform = CGAffineTransformMakeScale(CGFloat(1.0), CGFloat(1.0))
            }
        ...
        if side == .Left {
            ...
            contentViewContainer.center = CGPointMake(centerX - 200, contentViewContainer.center.y)
        }
